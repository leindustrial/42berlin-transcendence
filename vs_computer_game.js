...
function checkScores() {
    if (score1 >= endScore || score2 >= endScore) {
        ...
        if (score1 == endScore) {
            ctx.fillText("Player 1 has won!", canvas.width / 2, canvas.height / 2 + 25);
        } else {
            ctx.fillText("Player 2 has won!", canvas.width / 2, canvas.height / 2 + 25);
        }
...
function draw() {
    ...
    drawRect(1, 1, canvas.width - 2, canvas.height - 2, '#232222');


    // Draw paddles
    drawRect(5, paddle1Y, paddleWidth, paddleHeight, '#1faced');
    drawRect(canvas.width - paddleWidth - 5, paddle2Y, paddleWidth, paddleHeight, '#bf2bdd');
