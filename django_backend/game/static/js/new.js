document.addEventListener('DOMContentLoaded', function () {
    let gameState = 'start';
    let paddle_1, paddle_2, board, ball, score_1, score_2, message, winnerMessage;
    ...
    startGameBtn.addEventListener('click', function() {
        if (player1Input.value === player2Input.value) {
            ...
            document.getElementById('player1-name').innerHTML = player1Input.value;
            document.getElementById('player2-name').innerHTML = player2Input.value;
    ...
    function initializeElements() {
        paddle_1 = document.getElementById('paddle1');
        paddle_2 = document.getElementById('paddle2');
        board = document.getElementById('game-area');
        ball = document.getElementById('ball');
        score_1 = document.getElementById('score1');
        score_2 = document.getElementById('score2');
