...
function initializeOfflineTournament() {
    ...
    const paddleSpeed = 5;
    let paddle1Velocity = 0, paddle2Velocity = 0;
    let pl1Input = document.getElementById('player1NameInput');
    let pl2Input = document.getElementById('player2NameInput');
    let pl3Input = document.getElementById('player3NameInput');
    let pl4Input = document.getElementById('player4NameInput');
    let startGameBtn = document.getElementById('startGameBtn');
