export function startTournament() {
	...
	// WebSocket and event handling setup
	...
	tournamentSocket.onmessage = (event) => {
		...
		switch (data.type) {
			case 'update_tournament_chart':
				document.getElementById('usernames').textContent = data.user;
				username = data.user;
	...
	// 		if (sessionId) window.location.href = "/tour_game/" + sessionId + "/";
	// 	});
	// }
